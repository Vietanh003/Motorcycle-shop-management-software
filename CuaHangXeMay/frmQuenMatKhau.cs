...
namespace CuaHangXeMay
{
    public partial class frmQuenMatKhau : Form
    {
        ...
        private void link_dangKy_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            frmQuenMatKhau dong = new frmQuenMatKhau();
            dangNhap.dongMoForm(dk, dong);
        }
        ...
        private void btn_datLaiMatKhau_Click(object sender, EventArgs e)
        {
            ...
            if (soLoi == 0)
            {
                ...
                else
                {
                    ...
                    if (DStaiKhoan.Count > 0)
                    {
                        MessageBox.Show("Email của bạn không chính xác với email đã đăng ký", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        DStaiKhoan.Clear();
                    }
                    else
                    {
