  ...
  class DBConnect
    {
        ...
        static string strConnect = @"data source = LAPTOP-4UK5DRJR\SQLEXPRESS; initial catalog= QL_CuaHangXeGanMay; user id = sa; password= 123";
        //static string strConnect = "data source = A204PC31; initial catalog= QL_CuaHangXeGanMayDB; Integrated Security = true";
        //static string strConnect = "data Source = BATCHANHDAO\\SQLEXPRESS; Initial Catalog = QL_CuaHangXeGanMayDB; Integrated Security = true";
