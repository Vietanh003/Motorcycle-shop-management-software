...
namespace CuaHangXeMay
{
    public partial class Main : Form
    {
        ...
        private void đổiMậtKhẩuToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            dangNhap.dongMoForm(frmdoi, frmm);
        }
        ...
        private void đăngXuấtToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if(MessageBox.Show("Bạn có muốn đăng xuất!!!","Thông báo",MessageBoxButtons.OKCancel,MessageBoxIcon.Warning)==DialogResult.OK)
            {
                ...
                dangNhap.dongMoForm(frmDN, this);
            }    
        }
        ...
        {
            Frm_BaoCaoBanHang f = new Frm_BaoCaoBanHang();
        ...
        {
            frm fkb = new frm();
            dangNhap.dongMoForm(fkb, this);
        }

        private void xeToolStripMenuItem2_Click(object sender, EventArgs e)
        {


            Frm_BaoCaoXe f = new Frm_BaoCaoXe();
            f.ShowDialog();
        }
    }
}
